...
public class CpfResource {
	...
	@Path("perfil1")
	public List<PessoaPerfil1> obterListaPerfil1(
			@ApiParam(value="Lista de CPF's. Apenas números e separados por ponto e vírgula.")
			@NotNull @QueryParam("listaCPF") String lista) throws Exception {
		List<PessoaPerfil1> resultado = cpfBC.listarPerfil1(lista);
		return resultado;
	}
	...
	public List<PessoaPerfil1A> obterListaPerfil1A(
			@ApiParam(value="Lista de CPF's. Apenas números e separados por ponto e vírgula.")
			@QueryParam("listaCPF") String lista) throws Exception {
	...
	@Produces("application/json; charset=UTF-8")
	@Path("perfil2")
	public List<PessoaPerfil2> obterListaPerfil2(
			@ApiParam(value="Lista de CPF's. Apenas números e separados por ponto e vírgula.")
			@QueryParam("listaCPF") String lista) throws Exception {
		List<PessoaPerfil2> resultado = cpfBC.listarPerfil2(lista);
		return resultado;
	}
